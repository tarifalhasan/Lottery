...
import addInstaLike from '@/redux/instagramLike/instagramAction';
                ...
                >
                  ...
                  <div className=" order-3 lg:order-2 lg:col-span-3 flex flex-col items-stretch self-stretch justify-between mt-10 lg:mt-0">
                    ...
                    <div className="flex flex-col md:flex-row  w-full gap-2">
                      <div className="w-full">
                        <button className="flex w-full px-2 cursor-pointer justify-center border border-border py-2.5 rounded-full">
                      ...
                      <div className="w-full">
                        <button
                          ...
                          className="flex w-full px-2 cursor-pointer justify-center bg-[#01FF0B] py-2.5 rounded-full"
                        >
                          <div>
